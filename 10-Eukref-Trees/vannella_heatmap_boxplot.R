...
physeq_18S_clr_filter = subset_taxa(physeq_18S_clr, V7=="Vannella")
...
#ref taxa
tax_other <- read.table("annotations_vannella.txt", header=F, row.names=1, sep="\t")
...
#heatmap
pdf("vannella_asv_heatmap_clr.pdf")
...
#monthly
pdf("vannella_asv_boxplot_clr_month.pdf")
