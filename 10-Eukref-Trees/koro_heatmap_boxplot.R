...
physeq_18S_clr_filter = subset_taxa(physeq_18S, V7=="Korotnevella")
...
physeq_18S_clr_filter = subset_taxa(physeq_18S_clr, V7=="Korotnevella")
...
physeq_18S_clr_filter_bp = subset_taxa(glom_bp, V7=="Korotnevella")
