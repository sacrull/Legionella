...
physeq_18S_clr_filter = subset_taxa(physeq_18S_clr, V7=="Acanthamoeba")
...
#ref taxa
tax_other <- read.table("annotations.acan.txt", header=F, row.names=1, sep="\t")
...
#heatmap
pdf("acanthamoeba_asv_heatmap_clr.pdf")
...
physeq_18S_clr_filter_bp = subset_taxa(glom_bp, V7=="Acanthamoeba")
