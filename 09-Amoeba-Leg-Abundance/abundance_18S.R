...
ggplot(combined_leg_18S)  + 
  geom_bar(aes(x=Sample, y=Abundance,fill=V7),stat="identity", position="stack")+
  scale_fill_manual(values = c("Acanthamoeba" = "#D53E4F", "Dactylopodida" = "#F46D43", "Echinamoebida"="#FDAE61", "Korotnevella" ="#FEE08B", 
